...
\subfile{sections/0.前言.tex}
\newpage
\subfile{sections/1.数字经济总论.tex}
\newpage
\subfile{sections/2.数学与博弈论工具.tex}
\newpage
\subfile{sections/3.网络外部性与需求方规模经济.tex}
\newpage
\subfile{sections/4.平台经济与双边市场.tex}
\newpage
\subfile{sections/5.平台定价商业模式与价格歧视.tex}
\newpage
\subfile{sections/6.数字市场竞争与平台反垄断.tex}
\newpage
\subfile{sections/7.数据要素确权定价与数据资产.tex}
\newpage
\subfile{sections/8.数字经济与经济增长.tex}
\newpage
\subfile{sections/9.数字经济与就业收入分配.tex}
\newpage
\subfile{sections/10.数字金融金融科技与央行数字货币.tex}
\newpage
\subfile{sections/11.数字产业化产业数字化与数字贸易.tex}
\newpage
\subfile{sections/12.数据治理隐私保护与数字经济税收.tex}
\newpage
\subfile{sections/13.数字经济计量与因果推断方法.tex}
\newpage
\subfile{sections/14.前沿专题人工智能大模型与Web3.tex}
\newpage
\subfile{sections/15.总结数字企业生命周期.tex}
